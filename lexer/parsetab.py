...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement_expr','calc.py',60),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',74),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',78),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',82),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',86),
]
